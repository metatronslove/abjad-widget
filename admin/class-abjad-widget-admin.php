...
class Abjad_Widget_Admin {
    ...
    public function add_plugin_admin_menu() {
        add_menu_page(
            esc_html__( 'Abjad Widget Dashboard', 'abjad-widget' ),
            esc_html__( 'Abjad Widget', 'abjad-widget' ),
            'manage_options',
            $this->plugin_name,
        ...
        add_submenu_page(
            $this->plugin_name,
            esc_html__( 'Dashboard', 'abjad-widget' ),
            esc_html__( 'Dashboard', 'abjad-widget' ),
            'manage_options',
            $this->plugin_name,
            array( $this, 'display_dashboard_page' )
        ...
        add_submenu_page(
            $this->plugin_name,
            esc_html__( 'Widget Settings', 'abjad-widget' ),
            esc_html__( 'Settings', 'abjad-widget' ),
            'manage_options',
        ...
        add_submenu_page(
            $this->plugin_name,
            esc_html__( 'Style Editor', 'abjad-widget' ),
            esc_html__( 'Style Editor', 'abjad-widget' ),
            'manage_options',
        ...
        add_submenu_page(
            $this->plugin_name,
            esc_html__( 'Code Editor', 'abjad-widget' ),
            esc_html__( 'Code Editor', 'abjad-widget' ),
            'manage_options',
