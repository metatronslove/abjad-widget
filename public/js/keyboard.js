...
(function() {
  ...
  this.VKI_kts = this.VKI_kt = 'T\u00fcrk\u00e7e Q';  // Default keyboard layout
  this.VKI_langAdapt = true;  // Use lang attribute of input to select keyboard
  this.VKI_size = 2;  // Default keyboard size (1-5)
  this.VKI_sizeAdj = true;  // Allow user to adjust keyboard size
  this.VKI_clearPasswords = false;  // Clear password fields on focus
  this.VKI_imageURI = `${window.abjadWidgetConfig.pluginUrl}/js/keyboard.png`;  // If empty string, use imageless mode
    ...
    if (self.VKI_imageURI) {
      ...
      elem.onfocus = function() {
        if (self.VKI_target != this) {
          if (self.VKI_target) self.VKI_target = this; /* self.VKI_close(); */
          self.VKI_show(this);
        }
      };
  ...
  function VKI_buildKeyboardInputs() {
    ...
    VKI_addListener(document.documentElement, 'click', function(e) {
		...
		if (!self.VKI_keyboard.contains(target) && target !== self.VKI_target) {
			self.VKI_close();
		}
	}, false);
  }
