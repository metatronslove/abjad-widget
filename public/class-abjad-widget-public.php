...
class Abjad_Widget_Public {
    ...
    private function get_translation_strings() {
        return array(
            ...
            // Abjad order
            'abjadOrder'              => __( 'Abjad Order', 'abjad-widget' ),
            ...
            // Abjad table
            'abjadTable'              => __( 'Abjad Table', 'abjad-widget' ),
            ...
            'for_number'                  => __( 'For number', 'abjad-widget' ),
            'number_space'                => __( ' count ', 'abjad-widget' ),
            'calc_abjad_of'               => __( 'hesaplanan', 'abjad-widget' ),
